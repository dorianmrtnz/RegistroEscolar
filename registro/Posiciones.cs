...
namespace registro
{
    public partial class Posiciones : Form
    {
        ...
        public void llenarGrid()
        {
            ...
            {
                cnn.Open();
                SqlDataAdapter da = new SqlDataAdapter("select * from posiciones", cnn);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    cnn.Open();
                    SqlCommand comando = new SqlCommand("INSERT INTO posiciones VALUES (@posicion)", cnn);

                    comando.Parameters.Add("@posicion", System.Data.SqlDbType.VarChar);

                    comando.Parameters["@posicion"].Value = textBox1.Text;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (seleccionado > 0)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    {
                        cnn.Open();
                        SqlCommand comando = new SqlCommand("DELETE FROM posiciones WHERE posicion_id = '" + seleccionado + "'", cnn);
