...
namespace registro
{
    public partial class Secciones : Form
    {
        ...
        public void llenarGrid()
        {
            ...
            {
                cnn.Open();
                SqlDataAdapter da = new SqlDataAdapter("select * from secciones", cnn);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    cnn.Open();
                    SqlCommand comando = new SqlCommand("INSERT INTO secciones VALUES (@seccion)", cnn);

                    comando.Parameters.Add("@seccion", System.Data.SqlDbType.VarChar);

                    comando.Parameters["@seccion"].Value = textBox1.Text;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (seleccionado > 0)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    {
                        cnn.Open();
                        SqlCommand comando = new SqlCommand("DELETE FROM secciones WHERE seccion_id = '" + seleccionado + "'", cnn);
